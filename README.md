上周末参加了一个公司的 Tech Lead 培训—— Coach 来自 ThoughtWorks 中国区的两个资深 Tech Lead 和 ThoughtWorks 澳大利亚联邦区的资深 Tech Lead。两天的培训下来，学习到了不少的东西。内容只进不出，过些日子怕是会忘记了。于是，便有了这篇文章，一来记录下自己学习的东西；二来，结合自己的 “经验” 做一些总结。
...
在项目上，我不是一个擅长画远景的人，脚踏实地才是我的本质。

可我们需要一个好的技术远景，领先于业界，又或者是保持一流的水平。
...
跨功能性需求，又可以称为非功能性需求，是指依一些条件判断系统运作情形或其特性，而不是针对系统特定行为的需求。

这样的需求又可以分为两类 [^wiki_nonfun]：
...
> 为了正确的激励你自己，你就需要识别出真正能影响你的内在驱动力因素。在《管理 3.0》一书中提到了十条，团队内部成员的十大需求。

#### 任务委托

幸运的是，他/她并不孤单，。尽管他/她有一系列的活要做，但是有挑战性的工作是每个 Geek 乐意去做的事。
...
**不确定性之锥**，描述了项目中不确定性量的演变过程，即不确定性不仅随着时间的流逝而减少，而且也随风险管理，特别是决策的确立而减小。

![不确定性之锥](cone-of-uncertainty-for-powerpoint.jpg)

随着更多的研究和开发，有关项目的更多信息被学习，然后不确定性趋于减少，当所有剩余风险被终止或转移时达到0％。
...
尝试着使用《SIX PRINCIPLES OF INFLUENCE》来构建相关的影响力，即互惠互利利、承诺一致、社会认同、喜好、权威、稀缺。
Scarcity - 稀缺
